...
\begin{table}[H]
  \begin{tabular}{|C{5cm}|L{10cm}|}
    ...
    \hline
    {\tt Win + Alt + 0} & Three-way layout (2-horz, 1-vert) \\
    {\tt Win + Alt + 1} & Three-way layout (1-vert, 2-horz) \\
    {\tt Win + Alt + 2} & Two-way layout (2-vert) \\
    {\tt Win + Alt + 3} & Three-way layout (3-vert) \\
    {\tt Win + Alt + 4} & Four-way layout (2-horz, 2-vert) \\
    {\tt Win + Alt + 5} & Two-way layout (2-horz) \\
    {\tt Win + Alt + 6} & Six-way layout (2-horz, 3-vert) \\
    {\tt Win + Alt + 7} & Three-way layout (3-horz) \\
    {\tt Win + Alt + 8} & Four-way layout (4-vert) \\
    {\tt Win + Alt + 9} & Three-way layout (1-horz, 2-vert) \\
    \hline
